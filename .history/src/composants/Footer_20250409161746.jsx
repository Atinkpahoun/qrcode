...
const Footer = () => {
    return (
        <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-6 items-center px-5 md:px-14">
            <div className="flex flex-col md:flex-row md:items-center space-y-6 gap-x-1 items-center text-xl">
            ...
            <ul className="flex flex-wrap ju space-x-4">
