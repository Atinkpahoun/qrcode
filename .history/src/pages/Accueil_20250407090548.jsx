...
const Accueil = () => {
    return (
        <section className=' '>
            <div className='flex flex-col items-center justify-between md:flex-row gap-y-4 gap-x-2 md:gap-6 xl:gap-x-32 py-8 lg:py-10'>
                ...
                <div
                     className=' items-end'>
                    <img src={Ilustration} alt="" width={400} />
                </div>
            </div>
        </section>
    );
