    ...
    return (
        <section className=''>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-center space-y-4'>
                ...
                <div className='flex flex-col text-start items-baseline w-full items-center pt-0 lg:pt-4'>
                    <TypewriterEffect />
                    <p className='pt-14 text-center md:text-start lg:text-lg w-72 py-5'>Créez, customisez et téléchargez au même endroit vos codes QR en quelques clics.</p>
