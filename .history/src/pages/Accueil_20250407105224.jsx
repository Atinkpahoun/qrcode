...
const Accueil = () => {
    return (
        <section className=''>
            ...
            <div className='flex bg-blue-50 mx-5 md:mx-14 rounded-3xl'>
                <div className='hidden md:block max-w-[520px] max-h-[450px] invisible'>dsjcvofndvuefodsfijvnfedsvjifbvoiefdvrnfdvjkfnsdv dfjks vdvjknfdmcodj modivnf djk vmfjodndc mofj kj ndfvfjdc sdfjkdfjd vdrfn</div>
