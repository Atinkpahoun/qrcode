...
const Accueil = () => {
    return (
        <section className=' '>
            <div className='flex flex-col items-center md:flex-row gap-y-4 gap-x-2 md:gap-6 xl:gap-x-32 py-8 lg:py-10'>
                ...
                <div
                     className=''>
                    <img src={Ilustration} alt="" width={499} height={332.67} />
                </div>
            </div>
        </section>
    );
