      ...
      <div className="flex flex-wrap justify-center gap-8 lg:gap-10 mt-8">
        {filtered.map((qr, index) => {
          ...
          return (
            ...
            >
              <div className="space-x-2 justify-center flex flex-row md:flex-col pb-4 md:pb-0 pr-0 md:pr-4 border-b md:border-b-0 border-r-0 md:border-r border-[#0000FF]">
                <div ref={(el) => (qrSvgRefs.current[index] = el)}>
                  <QRCodeSVG
                    value={value}
                    fgColor={color}
                    bgColor={bgColor}
                ...
                <div ref={(el) => (qrRefs.current[index] = el)} className="hidden">
                  <QRCodeCanvas
                    value={value}
                    fgColor={color}
                    bgColor={bgColor}
                ...
                <div className="justify-center flex flex-col mt-4 space-y-3">
                  ...
                  <DownloadQR
                    ...
                    qrSvgRef={{ current: qrSvgRefs.current[index] }}
                    leNom={qr.nom}
                  />
                </div>
              </div>
...
export default Historique;
                ...
                <div ref={(el) => (qrSvgRefs.current[index] = el)} className="hidden">
                  <QRCodeSVG
                    value={value}
                    fgColor={color}
                    bgColor={bgColor}
