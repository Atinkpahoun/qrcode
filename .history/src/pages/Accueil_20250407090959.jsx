        ...
        <section className=' '>
            <div className='flex flex-col justify-between md:flex-row space-y-4 space-x-2 md:gap-6 xl:gap-x-32 py-8 lg:py-10'>
                ...
                <div className='flex flex-col space-y-4 justify-center items-start pt-0 lg:pt-4'>
                    <TypewriterEffect />
                    <p className=' text-center mdt text-lg lg:text-lg w-72 py-5'>Créez, customisez et téléchargez au même endroit vos codes QR en quelques clics.</p>
                    <button className="font-bold px-4 py-2 rounded-lg doto text-lg"><a href="/src/pages/CodeQR.jsx">Commencer</a></button>
                </div>
                <div
                     className=' items-end'>
