...
const Accueil = () => {
    return (
        <section className=' '>
            <div className='flex flex-col md:flex-row space-y-4 space-x-2 md:gap-6 xl:gap-x-32 py-8 lg:py-10'>
            
                <div className='flex flex-col space-y-4 w-full IT pt-0 lg:pt-4'>
                    <TypewriterEffect />
