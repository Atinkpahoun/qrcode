...
const Accueil = () => {
    return (
        <section style={{ backgroundImage: "url('https://cdn.dribbble.com/userupload/23415142/file/original-52d1343a12f605241ac8b687d7109dff.gif')" }} className=' h-screen w-full bg-cover bg-center'>
