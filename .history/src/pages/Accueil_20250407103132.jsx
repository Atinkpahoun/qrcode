...
const Accueil = () => {
    return (
        <section className=''>
            ...
            <div className='flex bg-blue-50 mx-5 md:mx-20 rounded-3xl'>
                <div className='hidden lg:block max-w-[520px] max-h-[450px]'></div>

                <div className='max-w-[520px] max-h-[450px] p-6'>
                    <h1 className='text-[24px] lg:text-[40px]'>Why you choose QRL Pixel</h1>
