...
const Accueil = () => {
    return (
        <section className=' '>
            <div className='flex flex-col space-y-4 space-x-2 py-8 lg:py-10'>
            
                <div className='flex flex-col space-y-4 w-full items-center pt-0 lg:pt-4'>
                    <TypewriterEffect />
                    <p className=' text-center md:text-start text-base lg:text-lg w-72 py-5'>Créez, customisez et téléchargez au même endroit vos codes QR en quelques clics.</p>
